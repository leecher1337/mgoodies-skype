...
#pragma pack(pop)
	...
	public:
		...
		{
		protected:
			friend class hash_multimap<TKey, TData>;				
			PListItem m_Item;
			hash_multimap<TKey, TData> * m_Owner;

			iterator(hash_multimap<TKey, TData> * Owner, PListItem Item)
				: m_Owner(Owner)
			{
				m_Owner->addRef();
				m_Item = Item;
	...
	template <typename TKey, typename TData>
	typename hash_multimap<TKey, TData>::PListItem hash_multimap<TKey, TData>::listInsert(PListItem BucketNode, PListItem Node)
	{
	...
	template <typename TKey, typename TData>
	typename hash_multimap<TKey, TData>::PListItem hash_multimap<TKey, TData>::listDelete(PListItem BucketNode, uint32_t Hash, const TKey & Key)
	{
		PListItem *prev, curr, next;
		do 
		{
	...
	template <typename TKey, typename TData>
	typename hash_multimap<TKey, TData>::PListItem hash_multimap<TKey, TData>::listDelete(PListItem BucketNode, PListItem Node)
	{
		PListItem *prev, curr, next;
		do 
		{
	...
	template <typename TKey, typename TData>
	bool hash_multimap<TKey, TData>::listFind(const PListItem BucketNode, const uint32_t Hash, const TKey & Key, const PListItem Node, PListItem * & Prev, PListItem & Curr, PListItem & Next)
	{
	...
	template <typename TKey, typename TData>
	typename hash_multimap<TKey, TData>::PListItem hash_multimap<TKey, TData>::initializeBucket(uint32_t Bucket, uint32_t Mask)
	{
	...
	template <typename TKey, typename TData>
	typename hash_multimap<TKey, TData>::PListItem hash_multimap<TKey, TData>::getBucket(uint32_t Bucket)
	{
	...
	template <typename TKey, typename TData>
	void hash_multimap<TKey, TData>::setBucket(uint32_t Bucket, PListItem Dummy)
	{
		THashTableData table;
		PHashTable *last;
		uint32_t mask;
	...
	template <typename TKey, typename TData>
	typename std::pair<typename hash_multimap<TKey, TData>::iterator, bool> hash_multimap<TKey, TData>::insert(const value_type & Val)
	{
	...
	template <typename TKey, typename TData>
	typename hash_multimap<TKey, TData>::iterator hash_multimap<TKey, TData>::find(const TKey & Key)
	{
		iterator dummyreference(this, NULL);
	...
	template <typename TKey, typename TData>
	typename hash_multimap<TKey, TData>::iterator hash_multimap<TKey, TData>::erase(const iterator & Where)
	{
		iterator dummyreference(this, NULL);
	...
	template <typename TKey, typename TData>
	size_t hash_multimap<TKey, TData>::erase(const TKey & Key)
	{
		uint32_t c = 0;
		iterator i = find(Key);
		while (i && (i->first == Key))
