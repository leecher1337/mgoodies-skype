...
!IF "$(CFG)" != "YAMN - Win32 Release" && "$(CFG)" != "YAMN - Win32 Debug" && "$(CFG)" != "YAMN - Win32 Release Win9x" && "$(CFG)" != "YAMN - Win32 Release Win2in1" && "$(CFG)" != "YAMN - Win32 Debug Win9x"
...
CPP=cl.exe
CPP_PROJ=/nologo /MD /W3 /GX /O1 /I "../../include" /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D "YAMN_DEBUG" /FR"$(INTDIR)\\" /Fp"$(INTDIR)\YAMN.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
...
RSC=rc.exe
RSC_PROJ=/l 0x405 /fo"$(INTDIR)\YAMN.res" /d "NDEBUG" 
BSC32=bscmake.exe
...
ALL : "..\..\bin7\Debug\plugins\YAMN.dll" "$(OUTDIR)\YAMN.bsc"
...
CLEAN :
	...
	-@erase "$(OUTDIR)\YAMN.exp"
	-@erase "$(OUTDIR)\YAMN.lib"
	-@erase "$(OUTDIR)\YAMN.map"
	-@erase "$(OUTDIR)\YAMN.pdb"
	-@erase "..\..\bin7\Debug\plugins\YAMN.dll"
	-@erase "..\..\bin7\Debug\plugins\YAMN.ilk"

"$(OUTDIR)" :
    if not exist "$(OUTDIR)/$(NULL)" mkdir "$(OUTDIR)"

CPP=cl.exe
CPP_PROJ=/nologo /MTd /W3 /Gm /GX /ZI /Od /I "../../include" /D "WIN32" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "YAMN_DEBUG" /FAs /Fa"$(INTDIR)\\" /FR"$(INTDIR)\\" /Fp"$(INTDIR)\YAMN.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /GZ /c 
...
RSC=rc.exe
RSC_PROJ=/l 0x405 /fo"$(INTDIR)\YAMN.res" /d "_DEBUG" 
BSC32=bscmake.exe
BSC32_FLAGS=/nologo /o"$(OUTDIR)\YAMN.bsc" 
BSC32_SBRS= \
	"$(INTDIR)\badconnect.sbr" \
...
"..\..\bin7\Debug\plugins\YAMN.dll" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
  $(LINK32_FLAGS) $(LINK32_OBJS)
<<
...
ALL : "..\..\bin7\Release\plugins\YAMN.dll" "$(OUTDIR)\YAMN.bsc"
...
CLEAN :
	...
	-@erase "$(OUTDIR)\YAMN.exp"
	-@erase "$(OUTDIR)\YAMN.lib"
	-@erase "..\..\bin7\Release\plugins\YAMN.dll"

"$(OUTDIR)" :
    if not exist "$(OUTDIR)/$(NULL)" mkdir "$(OUTDIR)"

CPP=cl.exe
CPP_PROJ=/nologo /MT /W3 /GX /O2 /I "../../include" /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D "WIN9X" /FR"$(INTDIR)\\" /Fp"$(INTDIR)\YAMN.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
...
"..\..\bin7\Release\plugins\YAMN.dll" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
  $(LINK32_FLAGS) $(LINK32_OBJS)
<<
...
CPP=cl.exe
CPP_PROJ=/nologo /MT /W3 /GX /O2 /I "../../include" /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D "WIN2IN1" /FR"$(INTDIR)\\" /Fp"$(INTDIR)\YAMN.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
...
CPP=cl.exe
CPP_PROJ=/nologo /MDd /W3 /Gm /GX /ZI /Od /I "../../include" /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "YAMN_DEBUG" /D "WIN9X" /D "YAMN_VER_BETA" /FR"$(INTDIR)\\" /Fp"$(INTDIR)\YAMN.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /GZ /c 
...
"$(INTDIR)\YAMN.res" : $(SOURCE) "$(INTDIR)"
	$(RSC) /l 0x405 /fo"$(INTDIR)\YAMN.res" /i "resources" /d "NDEBUG" $(SOURCE)
...
"$(INTDIR)\YAMN.res" : $(SOURCE) "$(INTDIR)"
	$(RSC) /l 0x405 /fo"$(INTDIR)\YAMN.res" /i "resources" /d "_DEBUG" $(SOURCE)
