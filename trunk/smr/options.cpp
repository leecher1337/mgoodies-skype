...
void LoadOptions()
{
	...
	opts.pool_timer_status = DBGetContactSettingWord(NULL, MODULE_NAME, OPT_CHECK_ONSTATUS_TIMER, 15);
...
static OptPageControl pageControls[] = { 
	...
	{ CONTROL_SPIN,		IDC_CHECK_ONSTATUS_TIMER, OPT_CHECK_ONSTATUS_TIMER, (WORD) 15, IDC_CHECK_ONSTATUS_TIMER_SPIN, (WORD) 1, (WORD) 255 }
};
