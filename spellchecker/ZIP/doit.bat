...
rem copy ..\..\..\bin\release\Plugins\%name%W.dll
...
rem "C:\Program Files\Filzip\Filzip.exe" -a -rp %name%W.zip %name%W.dll Docs
...
rem "C:\Program Files\FileZilla\FileZilla.exe" -u .\%name%W.zip %ftp% -overwrite -close 
